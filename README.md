...
🪟 Windows
Download DocRefinePro_Win_vXX.zip.

Right-click the zip file -> Extract All.

Open the folder and run DocRefine Pro.exe.

Note: If Windows SmartScreen appears, click "More Info" -> "Run Anyway".

🍎 macOS
Download DocRefinePro_Mac_vXX.dmg.

Double-click the .dmg file to mount it.

Drag the DocRefine Pro app into your Applications folder.
...
Right-Click (or Control+Click) on DocRefinePro.

Select Open from the menu.

A popup will appear saying "macOS cannot verify the developer". Click Open.
...
# Clone the repo
git clone https://github.com/jasonweblifestores/DocRefinePro.git
cd DocRefinePro
...
python main.py
📄 License
This project is open-source. See the LICENSE file for details. DocRefine Pro utilizes Poppler (GPL) and Tesseract OCR (Apache 2.0).